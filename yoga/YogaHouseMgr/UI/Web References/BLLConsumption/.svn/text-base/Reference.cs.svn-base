...
namespace UI.BLLConsumption {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="WSConsumptionSoap", Namespace="http://tempuri.org/")]
    ...
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(ConsumptionRecord[]))]
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(EntityKeyMember[]))]
    public partial class WSConsumption : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public WSConsumption() {
            this.Url = global::UI.Properties.Settings.Default.UI_BLLConsumption_WSConsumption;
        ...
        public ConsumptionRecord[] Search(System.DateTime begin, System.DateTime end, string cardNo, string name, int operatorId, int gid, ref int page, int pageSize, out int totalPages) {
            ...
            return ((ConsumptionRecord[])(results[0]));
        }
        
        /// <remarks/>
        public void SearchAsync(System.DateTime begin, System.DateTime end, string cardNo, string name, int operatorId, int gid, int page, int pageSize) {
            this.SearchAsync(begin, end, cardNo, name, operatorId, gid, page, pageSize, null);
        }
        
        /// <remarks/>
        public void SearchAsync(System.DateTime begin, System.DateTime end, string cardNo, string name, int operatorId, int gid, int page, int pageSize, object userState) {
    ...
    public partial class SearchCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public ConsumptionRecord[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((ConsumptionRecord[])(this.results[0]));
            }
        }
